...
void init(SCENE_T *scene)
{
   ...
   //1: sphere values
   temp = new Vector(0.5, 0.8, 4.0);
   sphere = new Sphere(0.5,*temp);
   scene -> objs[0] = sphere;

   scene -> objs[0]->setColorR(1, 0.8);
   scene -> objs[0]->setColorG(1, 0.0);
   scene -> objs[0]->setColorB(1, 0.0);
   ...
   scene -> objs[0]->setReflectivity(0.7);
   

   //2: sphere values
   temp = new Vector(-0.5, 0.15, 4.2);
   sphere = new Sphere(0.6,*temp);
   scene -> objs[1] = sphere;

   scene -> objs[1]->setColorR(1, 0.0);
   scene -> objs[1]->setColorG(1, 0.8);
   ...
   scene -> objs[2]->setColorR(1, 1.0);
   scene -> objs[2]->setColorG(1, 1.0);
   scene -> objs[2]->setColorB(1, 1.0);

   scene -> objs[2]->setColorR(2, 0.1);
   scene -> objs[2]->setColorG(2, 0.1);
   scene -> objs[2]->setColorB(2, 0.1);

   scene -> objs[2]->setChecker(true);

   scene -> objs[2]->setReflectivity(0.1);

   //4: box values
   temp = new Vector(0.3, -0.6, 2.3);
   temp2 = new Vector(0.7, -0.2, 3.0);
   box = new Box(*temp, *temp2);
   scene -> objs[3] = box;

   scene -> objs[3]->setColorR(1, 0.0);
   scene -> objs[3]->setColorG(1, 0.0);
   scene -> objs[3]->setColorB(1, 1.0);
   ...
   scene -> objs[3]->setReflectivity(0.0);
...
int main()
{
   ...
   ofstream outfile("img.ppm", ofstream::out);
   if(!outfile)
   {
